 ...
 */
public class AgentGroupReportFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener {
    ...
    public class TitleViewHolder {
        ...
        public void init() {
            this.title_new_customer_count_ll.setOnClickListener(AgentGroupReportFragment.this);
            this.title_total_agent_count_ll.setOnClickListener(AgentGroupReportFragment.this);
            this.title_reg_customer_count_ll.setOnClickListener(AgentGroupReportFragment.this);
            this.title_new_order_count_ll.setOnClickListener(AgentGroupReportFragment.this);
            this.title_order_count_ll.setOnClickListener(AgentGroupReportFragment.this);
        }
